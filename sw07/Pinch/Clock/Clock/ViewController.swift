...
class ViewController: UIViewController {
    ...
    var oWidth: CGFloat = 1.0
    var oHeight: CGFloat = 1.0
    var nWidth: CGFloat = 1.0
    var nHeight: CGFloat = 1.0
    ...
    override func viewDidLoad() {
        ...
        oWidth = imgView.frame.width
        oHeight = imgView.frame.width
        nWidth = imgView.frame.width
        nHeight = imgView.frame.width
        centerX = oWidth/2
        centerY = oHeight/2
...
//        imgView.frame.size = CGSize(width: nWidth, height: nHeight)
        ...
        print(pinch.scale)
        nWidth = oWidth * pinch.scale
        nHeight = oHeight * pinch.scale
    ...
    // 현재 초, 분, 시를 타입변경
        ...
        imgView.frame.size = CGSize(width: nWidth, height: nHeight) // imgView.frame.size변경
